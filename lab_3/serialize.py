...
class Serialization:
    """Class for serialization and deserialization different file types"""
    ...
    def read_public_key(self, file_path: str) -> rsa.RSAPublicKey:
        """
    ...
    def read_private_key(self, file_path: str) -> rsa.RSAPrivateKey:
        """
